...
const TaskTables = ({ name, listName }) => {
  ...
  const properFilterToday = (todo) => {
    const day = 86400000; // 1 day in ms
    var filterStartDeadline = new Date(new Date().setHours(0,0,0,0)).getTime() + TZOFFSET;
    var filterEndDeadline = new Date(new Date().setHours(23,59,59,0)).getTime() + TZOFFSET;
    var filterStartTododate = new Date(new Date().setHours(0,0,0, 0)).getTime() + TZOFFSET;
    var filterEndTododate = new Date(new Date().setHours(23,59,59, 0)).getTime() + TZOFFSET;
  ...
  const properFilterWeek = (todo) => {
    const day = 86400000; // 1 day in ms
    var filterStartDeadline = new Date(new Date().setHours(0,0,0,0)).getTime() + TZOFFSET + day;
    var filterEndDeadline = new Date(new Date().setHours(23,59,59,0)).getTime() + TZOFFSET + 6 * day;
    var filterStartTododate = new Date(new Date().setHours(0,0,0, 0)).getTime() + TZOFFSET + day;
    var filterEndTododate = new Date(new Date().setHours(23,59,59, 0)).getTime() + TZOFFSET + 6 * day;
    var todoDeadline =
      todo.deadline == null ? null : new Date(todo.deadline).getTime();
    var todoTodoDate =
      todo.tododate == null ? null : new Date(todo.tododate).getTime();
